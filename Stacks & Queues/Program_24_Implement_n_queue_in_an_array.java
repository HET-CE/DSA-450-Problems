public class Program_24_Implement_n_queue_in_an_array {
    int k;
    int n;
    int[] arr;
    int[] front;
    ...
    Program_24_Implement_n_queue_in_an_array(int k, int n){
    ...
    {
        int k = 3, n = 10;
        Program_24_Implement_n_queue_in_an_array ks=  new Program_24_Implement_n_queue_in_an_array(k, n);
