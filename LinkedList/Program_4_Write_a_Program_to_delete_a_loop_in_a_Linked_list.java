public class Program_4_Write_a_Program_to_delete_a_loop_in_a_Linked_list {
    static Node head;
    ...
    {
        Program_4_Write_a_Program_to_delete_a_loop_in_a_Linked_list list = new Program_4_Write_a_Program_to_delete_a_loop_in_a_Linked_list();
