...
public class Program_11_Merge_two_BST_V_V_V_IMP {
    static class Node {
        int data;
        Node left, right;
    ...
    Program_11_Merge_two_BST_V_V_V_IMP() {
        root = null;
    }
    ...
    public static void main(String[] args) {
        Program_11_Merge_two_BST_V_V_V_IMP tree1 = new Program_11_Merge_two_BST_V_V_V_IMP();
        ...
        Program_11_Merge_two_BST_V_V_V_IMP tree2 = new Program_11_Merge_two_BST_V_V_V_IMP();
        tree2.root = new Node(80);
        tree2.root.left = new Node(40);
        tree2.root.right = new Node(120);

        Program_11_Merge_two_BST_V_V_V_IMP tree = new Program_11_Merge_two_BST_V_V_V_IMP();
